...
#               added to the system's Registry; using this module, send the
#               output to .csv format and sort on column B to get the names
#               to line up
#
...
#   ::rptMsg("svc2 v.".$VERSION); # 20110830 [fpi] + banner
