#-----------------------------------------------------------
# networklist.pl
#   Plugin to extract information from the  NetworkList key,
#   including the MAC address of the default gateway
#
# Change History
#   20090811 [hca] % created
#   20090812 [hca] * updated code to parse DateCreated and DateLastConnected
...
sub pluginmain {
    ...
    ::rptMsg("networklist v.".$VERSION); # 20110830 [fpi] + banner
