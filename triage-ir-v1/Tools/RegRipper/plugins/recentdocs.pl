...
#
# Change history
#   20080418 [qar] * Minor update to address NTUSER.DAT files that have
#                    MRUList values in this key, rather than MRUListEx values
#   20090115 [qar] * Minor update to keep plugin from printing terminating
#                    MRUListEx value of 0xFFFFFFFF
#   20100405 [qar] * Updated to use Encode::decode to translate strings
...
sub pluginmain {
    ...
    ::rptMsg("recentdocs v.".$VERSION); # 20110830 [fpi] + banner
