...
#               the ServiceDll value; During intrusions, a service key may be
#               added to the system's Registry; this module provides a quick
#               look, displaying the Service names
#               (in malware, sometimes random) and the ServiceDll value,
#               sorted based on the LastWrite time of the
#               <service name>\Parameters subkey.
#
...
sub pluginmain {
    ...
    ::rptMsg("svcdll v.".$VERSION); # 20110830 [fpi] + banner
