...
#
# Change history
#   20091110 [mta] % created
#   20091125 [hca] * modified
...
# 
# Note: derived from the officeDocs plugin copyright 2008-2009
#       H. Carvey, mangled 2009 M. Tarnawsky
#
# Michael Tarnawsky forensics@mialta.com
#-----------------------------------------------------------
package oisc;
use strict;
...
sub pluginmain {
    ...
    ::rptMsg("oisc v.".$VERSION); # 20110830 [fpi] + banner
