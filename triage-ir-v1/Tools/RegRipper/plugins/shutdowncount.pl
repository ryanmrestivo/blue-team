...
#
# References
#   thanks to DC1743@gmail.com, value info first seen at:
#       http://forensicsfromthesausagefactory.blogspot.com/2008/06/
#              install-dates-and-shutdown-times-found.html
#
...
sub pluginmain {
    ...
    ::rptMsg("shutdowncount v.".$VERSION); # 20110830 [fpi] + banner
