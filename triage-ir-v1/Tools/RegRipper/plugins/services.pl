#-----------------------------------------------------------
# services.pl
#   Access System hive file to get the services
# 
# Change history
#   20080505 [hca] + collection of ImagePath and DisplayName, if avail.
#   20080507 [hca] * added collection of Type and Start values; separated
...
sub pluginmain {
    ...
    ::rptMsg("services v.".$VERSION); # 20110830 [fpi] + banner
