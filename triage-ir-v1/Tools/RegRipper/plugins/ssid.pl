...
#
# Change History:
#   20090807 [qar] * updated code in accordance with WZC_WLAN_CONFIG 
#                    structure
#   20091102 [qar] + added code to parse EAPOL values for SSIDs
#   20100301 [qar] * updated References; removed dwCtlFlags being  printed;
...
sub pluginmain {
    ...
    ::rptMsg("ssid v.".$VERSION); # 20110830 [fpi] + banner
