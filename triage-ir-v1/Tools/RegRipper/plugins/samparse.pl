...
#
# Change history
#   20080415 [qar] % created
#   20090413 [qar] + account creation date
#   20091020 [qar] + extracting UserPasswordHint value
#   20100712 [qar] + References entry
#   20110303 [qar] * Fixed parsing of SID, added check for account type
...
#   20110901 [fpi] * eliminated old "samparse.pl" and renamed this plugin
#                    "samparse2.pl" to "samparse.pl". Updated version number
...
sub pluginmain {
    ...
    ::rptMsg("samparse v.".$VERSION); # 20110830 [fpi] + banner
