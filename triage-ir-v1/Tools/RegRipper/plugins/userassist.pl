...
#
# Change history
#   20080301 [hca] * updated to include run count along with date
#   20080726 [hca] + added reference to help examiner understand Control
...
sub pluginmain {
    ...
    ::rptMsg("userassist v.".$VERSION); # 20110830 [fpi] + banner
