#-----------------------------------------------------------
# mountdev.pl
#   Access System hive file to get the MountedDevices
# 
# Change history
#   20091116 [hca] * changed output
#   20110830 [fpi] + banner, no change to the version number
#   20110901 [fpi] * eliminated old "mountdev.pl" and renamed this plugin
#                    "mountdev2.pl" to "mountdev.pl". Updated version number
...
sub pluginmain {
    ...
    ::rptMsg("mountdev v.".$VERSION); # 20110830 [fpi] + banner
