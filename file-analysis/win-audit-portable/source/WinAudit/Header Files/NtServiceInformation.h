...
class NtServiceInformation
{
    public:
        ...
        // Methods
        void    GetServiceRecords( TArray< AuditRecord >* pRecords );
    ...
    private:
        ...
        // Methods
        void    GetServiceConfig( SC_HANDLE hSCManager,
                                  LPCWSTR pszServiceName,
                                  String* pStartType, String* pPathName, String* pStartName );
        void    GetServices( DWORD serviceType, TArray< AuditRecord >* pRecords );
        void    TranslateCurrentState( DWORD currentState, String* pCurrentState );
        void    TranslateServiceType( DWORD serviceType, String* pServiceType );
        void    TranslateStartType( DWORD startType, String* pStartType );
