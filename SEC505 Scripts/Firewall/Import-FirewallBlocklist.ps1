...
#
#.Example 
#    Import-FirewallBlocklist.ps1 -inputfile IpToBlock.txt
#
#.Example
#    Import-FirewallBlocklist.ps1 -inputfile Iptoblock.txt -profiletype public
#
#.Example
#    Import-FirewallBlocklist.ps1 -inputfile Iptoblock.txt -interfacetype wireless
#
#.Example 
#    Import-FirewallBlocklist.ps1 -inputfile IpToBlock.txt -deleteonly
#
#.Example 
#    Import-FirewallBlocklist.ps1 -rulename IpToBlock -deleteonly
#
